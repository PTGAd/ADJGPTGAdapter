...
- (NSString *)insterstitialAdScenceId {
    if ([[NSUserDefaults standardUserDefaults] stringForKey:@"insterstitialadscenceid"] == nil) {
        return @"";
    }
    return [[NSUserDefaults standardUserDefaults] stringForKey:@"insterstitialadscenceid"];
}

- (void)setinsterstitialAdScenceId:(NSString *)insterstitialAdScenceId {
    [[NSUserDefaults standardUserDefaults] setValue:insterstitialAdScenceId forKey:@"insterstitialadscenceid"];
}
