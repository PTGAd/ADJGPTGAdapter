Pod::Spec.new do |spec|
  ...
  spec.name         = "ADJGPTGAdapter"
  spec.version      = "1.0.0"
  spec.summary      = "A short description of ADJGPTGAdapter."
  ...
  spec.homepage     = "https://github.com/PTGAd/ADJGPTGAdapter"
  ...
  spec.source       = { :git => "https://github.com/PTGAd/ADJGPTGAdapter", :tag => "#{spec.version }" }
  ...
  spec.vendored_frameworks =  'Frameworks/PTGJGAdapter.framework'
